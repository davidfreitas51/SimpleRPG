...
namespace Simple_RPG
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Monster stoneGuardian = new Monster(100, 10000, stoneGuardianAttacks, "Stone Guardian", "The earth trembles beneath an approaching monster..", "A stone creature strides purposefully toward you!!", Helpful.Utility.GenerateRandomNumber(80, 160));
