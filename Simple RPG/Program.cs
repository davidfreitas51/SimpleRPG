...
namespace Simple_RPG
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Monster shadowStalker = new Monster(100, 80, shadowStalkerAttacks, "Shadow Stalker", "You witness your own shadow expanding...", "An unsettling dark figure forms in front of you!", Helpful.Utility.GenerateRandomNumber(80, 160));
